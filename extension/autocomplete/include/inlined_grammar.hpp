...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"SelectStatement <- SelectOrParens RepeatSetopSelect* ResultModifiers?\n"
	"RepeatSetopSelect <- SetOpClause SelectStatement\n"
	...
	"EnumSelectType <- 'ENUM'i Parens(SelectStatement)\n"
