...
// Generation timestamp: 2024-10-28 10:18:30
//
...
DescribeStatement <- 'DESCRIBE'i (Identifier / SimpleSelect)
...
SelectClause <- 'SELECT'i (StarToken / List(AliasedExpression))
...
CountStarExpression <- 'COUNT'i Parens(StarToken)
...
LikeOperator <- NotModifier? LikeOrIlike
...
const std::vector<std::string> unreserved_keywords = {
    "ABORT",
    "ABSOLUTE",
    "ACCESS",
    "ACTION",
