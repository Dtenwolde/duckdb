...
// { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	return
// transformer.Transform<DistinctClause>(list_pr.Child<ChoiceParseResult>(0).GetResult());
// }
//
...
// { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	MacroParameter parameter; 	parameter.expression =
// transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.Child<ListParseResult>(3)); 	parameter.name =
// transformer.Transform<string>(list_pr.Child<ListParseResult>(0)); 	parameter.is_default = true;
// 	transformer.TransformOptional<LogicalType>(list_pr, 1, parameter.type);
// 	return parameter;
// }
//
// vector<unique_ptr<ParsedExpression>> PEGTransformerFactory::TransformTableFunctionArguments(PEGTransformer
// &transformer,
//                                                                                             ParseResult
//                                                                                             &parse_result) {
...
// }
//
// TableAlias PEGTransformerFactory::TransformTableAliasWithoutAs(PEGTransformer &transformer, ParseResult
// &parse_result) { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	TableAlias result; 	result.name =
// list_pr.Child<IdentifierParseResult>(0).identifier; 	transformer.TransformOptional<vector<string>>(list_pr, 1,
// result.column_name_alias); 	return result;
// }
//
// vector<string> PEGTransformerFactory::TransformColumnAliases(PEGTransformer &transformer, ParseResult &parse_result)
// { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	vector<string> result; 	auto &extract_parens =
// ExtractResultFromParens(list_pr.Child<ListParseResult>(0)); 	auto alias_list =
// ExtractParseResultsFromList(extract_parens); 	for (auto alias : alias_list) {
...
// { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	auto inner_table_ref =
// transformer.Transform<unique_ptr<TableRef>>(list_pr.Child<ListParseResult>(0)); 	auto &join_or_pivot_opt =
// list_pr.Child<OptionalParseResult>(1); 	if (!join_or_pivot_opt.HasResult()) { 		return inner_table_ref;
// 	}
...
// { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	PivotColumn result; 	result.unpivot_names =
// transformer.Transform<vector<string>>(list_pr.GetChild(0)); 	if (result.unpivot_names.size() != 1) { 		throw
// ParserException("UNPIVOT requires a single column name for the PIVOT IN clause");
// 	}
...
// { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	auto &extract_parens =
// ExtractResultFromParens(list_pr.Child<ListParseResult>(1)); 	return
// transformer.Transform<unique_ptr<AtClause>>(extract_parens);
// }
//
...
// }
//
// unique_ptr<TableRef> PEGTransformerFactory::TransformValuesRef(PEGTransformer &transformer, ParseResult
// &parse_result) { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	auto values_select_statement =
...
// }
//
// LimitPercentResult PEGTransformerFactory::TransformLimitClause(PEGTransformer &transformer, ParseResult
// &parse_result) { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	return
// transformer.Transform<LimitPercentResult>(list_pr.Child<ListParseResult>(1));
// }
//
// LimitPercentResult PEGTransformerFactory::TransformLimitValue(PEGTransformer &transformer, ParseResult &parse_result)
// { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	return
// transformer.Transform<LimitPercentResult>(list_pr.Child<ChoiceParseResult>(0).GetResult());
// }
//
...
// };
//
// GroupByNode PEGTransformerFactory::TransformGroupByExpressions(PEGTransformer &transformer, ParseResult
// &parse_result) { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	auto result =
// transformer.Transform<GroupByNode>(list_pr.Child<ChoiceParseResult>(0).GetResult()); 	return result;
// }
//
...
//                                                                       GroupingExpressionMap &map, GroupByNode
//                                                                       &result) {
...
// { 	auto &list_pr = parse_result.Cast<ListParseResult>(); 	auto &extract_parens =
// ExtractResultFromParens(list_pr.GetChild(1)); 	return transformer.Transform<optional_idx>(extract_parens);
// }
//
